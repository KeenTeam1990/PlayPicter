...
- (void)createUI{
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMakeKT(0, 0, 375, 667) collectionViewLayout:flow];
    
    //设置代理
   _collectionView.backgroundColor = [UIColor whiteColor];
   _collectionView.layer.contents =(__bridge id)UIColorFromRGB(248, 249, 251).CGColor;
    //[UIImage imageNamed:@"backgroudPic"].CGImage;
...
#pragma ---更改添加按钮背景图片
        cell.imgView.image = [UIImage imageNamed:@"photo"];
